...
melrose_or_santamonica([[_,_,_,_,_],[_,_,_,_,_],[_,_,_,_,_],[_,_,_,_,_],[_,_,_,_,_],[_,_,A,_,_]]) :- A=melrose; A=santa_monica.

no_dup_street([[_,_,A,_,_],[_,_,B,_,_],[_,_,C,_,_],[_,_,D,_,_],[_,_,E,_,_],[_,_,F,_,_]]) :- A\==B,A\==C,A\==D,A\==E,A\==F,B\==C,B\==D,B\==E,B\==F,C\==D,C\==E,C\==F,D\==E,D\==F,E\==F.
 
myprogram(Data)  :-    =(Data, [[_,_,_,_,_],[_,_,_,_,_],[_,_,_,_,_],[_,_,_,_,_],[_,_,_,_,_],[_,_,_,_,_]]),
